...
def solve_contingencies(input_file, output_file, output_file_roll, contingency, reductionto, duration, model, carriers_dispatchable, horizon, country, o, tl, bus):
   ...
   #build inv and noinv model:
    if model == 'inv':
        allow_inv(n_new,n, country, gen_cut) 
...
#dispatchable carriers
carriers_dispatchable = ['biomass','coal', 'CCGT', 'OCGT', 'lignite', 'hydro','nuclear']
solve_contingencies(input_file, output_file, output_file_roll, contingency, reductionto, duration, model, carriers_dispatchable, horizon, country, o, tl, bus)
