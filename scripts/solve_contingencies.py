...
def solve_contingencies(input_file, output_file, output_file_roll, contingency, reductionto, duration, model, cut_start, horizon):
...
if __name__ == "__main__":
    ...
    duration = sys.argv[6]
    model = sys.argv[7]
    cut_start = pd.to_datetime(sys.argv[9])
    horizon = int(sys.argv[8])
    #output_file_base_roll = sys.argv[10]
print(horizon, type(horizon))
print(cut_start)
    
solve_contingencies(input_file, output_file, output_file_roll, contingency, reductionto, duration, model, cut_start, horizon)
